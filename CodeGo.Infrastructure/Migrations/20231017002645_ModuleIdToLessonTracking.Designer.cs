...
namespace CodeGo.Infrastructure.Migrations
{
    ...
    [Migration("20231017002645_ModuleIdToLessonTracking")]
    partial class ModuleIdToLessonTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeGo.Domain.CategoryAggregateRoot.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeGo.Domain.RankingAggregateRoot.Ranking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeGo.Domain.ProgressAggregateRoot.Progress", b =>
                {
                    b.OwnsMany("CodeGo.Domain.CourseAggregateRoot.ValueObjects.ModuleId", "CompletedModuleIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("progressCompletedModuleIds", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ProgressId");
                        });

                    b.OwnsMany("CodeGo.Domain.CourseAggregateRoot.ValueObjects.SectionId", "CompletedSectionIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("progressCompletedSectionIds", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ProgressId");
                        });

                    b.OwnsMany("CodeGo.Domain.LessonTrackingAggregateRoot.ValueObjects.LessonTrackingId", "LessonTrackingIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("progressLessonTrackingIds", (string)null);
            ...
            modelBuilder.Entity("CodeGo.Domain.RankingAggregateRoot.Ranking", b =>
                {
                    b.OwnsMany("CodeGo.Domain.RankingAggregateRoot.Entities.RankingProgress", "RankingProgresses", b1 =>
                        {
                            ...
                            b1.OwnsOne("CodeGo.Domain.UserAggregateRoot.ValueObjects.ExperiencePoints", "Points", b2 =>
                                {
                                    b2.Property<Guid>("RankingProgressRankingId")
                                        .HasColumnType("uuid");

                                    b2.Property<Guid>("RankingProgressId")
                                        .HasColumnType("uuid");
                    ...
                    b.OwnsOne("CodeGo.Domain.RankingAggregateRoot.ValueObjects.Period", "Period", b1 =>
                        {
                            b1.Property<Guid>("RankingId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("RankingProgresses");
                });
